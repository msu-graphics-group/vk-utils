...
VkDescriptorPool createDescriptorPool(VkDevice a_device, const std::vector<std::pair<VkDescriptorType, uint32_t>> &a_descrTypes, unsigned a_maxSets)
{
...
DescriptorMaker::DescriptorMaker(VkDevice a_device, const std::vector<std::pair<VkDescriptorType, uint32_t>> &a_maxDescrTypes, uint32_t a_maxSets) : m_device(a_device)
{
...
void DescriptorMaker::BindEnd(VkDescriptorSet *a_pSet, VkDescriptorSetLayout *a_pLayout)
{
  ...
  std::vector<std::pair<VkDescriptorType, uint32_t>> descrTypes;
  ...
  for (size_t i = 0; i < descriptorsInSet; ++i)
  {
    ...
    case VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_KHR:
      dAccStructInfos[accStructInfoIdx] = {VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_ACCELERATION_STRUCTURE_KHR,
                                      VK_NULL_HANDLE,
                                     1, //TODO: support accStruct arrays
                                      &m_bindings[i].accelStruct};
