...
#undef STR
  ...
  VkRenderPass createRenderPass(VkDevice a_device, RenderTargetInfo2D a_rtInfoColor, RenderTargetInfo2D a_rtInfoDepth) {
    VkAttachmentDescription colorAttachment = {};
    colorAttachment.format = a_rtInfoColor.format;
    colorAttachment.samples = VK_SAMPLE_COUNT_1_BIT;
    colorAttachment.loadOp = a_rtInfoColor.loadOp;
    colorAttachment.storeOp = VK_ATTACHMENT_STORE_OP_STORE;
    colorAttachment.stencilLoadOp = VK_ATTACHMENT_LOAD_OP_DONT_CARE;
    colorAttachment.stencilStoreOp = VK_ATTACHMENT_STORE_OP_DONT_CARE;
    colorAttachment.initialLayout = a_rtInfoColor.initialLayout;
    colorAttachment.finalLayout = a_rtInfoColor.finalLayout;
    ...
    VkAttachmentDescription depthAttachment = {};
    depthAttachment.format = a_rtInfoDepth.format;
    depthAttachment.samples = VK_SAMPLE_COUNT_1_BIT;
    depthAttachment.loadOp = a_rtInfoDepth.loadOp;
    depthAttachment.storeOp = VK_ATTACHMENT_STORE_OP_DONT_CARE;
    depthAttachment.stencilLoadOp = VK_ATTACHMENT_LOAD_OP_DONT_CARE;
    depthAttachment.stencilStoreOp = VK_ATTACHMENT_STORE_OP_DONT_CARE;
    depthAttachment.initialLayout = a_rtInfoDepth.initialLayout;
    depthAttachment.finalLayout = a_rtInfoDepth.finalLayout;
